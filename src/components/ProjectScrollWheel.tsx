...
function ProScrolldiv(){
    ...
    <div className = "container" ref = {main}>
        <div className="scrollmenu">
            ...
            <div>      <ProshowCase title = "Chess AI" summary = "Chess AI bot that utelizes min-max algorithm optimized by alpha-beta pruning. Chess rating somewhere between 1300-1700." img = {Chess}></ProshowCase></div>     
            ...
            <div > <ProshowCase title = "Cellular Automata" summary = "JavaScript object oriented programming which accurately/efficiently simulates a Belousov Zhabotinsky reaction" img = {Automata}></ProshowCase></div>
            <div ref ={ref} id = "startel">      <ProshowCase title = "Chess AI" summary = "Chess AI bot that utelizes min-max algorithm optimized by alpha-beta pruning. Chess rating somewhere between 1300-1700." img = {Chess}></ProshowCase></div>     
